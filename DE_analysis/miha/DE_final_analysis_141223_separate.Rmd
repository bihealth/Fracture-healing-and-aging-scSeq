...
```{r cell numbers,fig.height=10,fig.width=10}
...
```{r volc1, fig.width=13,fig.height=22}
...
write.table(res_df,"results_list_211223/de_results_separate_analysis.tsv", quote=F, sep="\t",row.names = F)
```
