...
path <- "/fast/groups/cubi/work/milekm/mireille/de/rerun/sc-batch-analysis/out_rds"
...
# write.csv(markers,'290124_cluster_markers_rna.csv',row.names=FALSE)
markers <- read.csv('290124_cluster_markers_rna.csv',
...
# write.csv(markers,'290124_cluster_markers_adt.csv',row.names=FALSE)
markers <- read.csv('290124_cluster_markers_adt.csv',
                    stringsAsFactors=FALSE)
...
saveRDS(sobj, "sobj.annotated.310124.rds")
```
