...
fig4e<- sub[[]] %>%
  ...
  theme(axis.title = element_text(size = 8), 
        ...
        plot.title = element_text(size = 8,face="bold",hjust = 0.5,))+
  scale_color_manual(name= "Time",values = c("dodgerblue3","orange2")) + 
  labs(title ="Hematoma immune-aged (slingshot)", x = c(color =''), y = 'Pseudotime') 
...
labs <- c("Young"="Young","Aged"="Aged", "ImmunoAged"="Immune-aged")
...
sf4e<- sub[[]] %>%
  ...
  theme(axis.title = element_text(size = 8), 
        ...
        plot.title = element_text(size = 8,face="bold",hjust = 0.5,))+
  scale_color_manual(name= "Time",values = c("dodgerblue3","orange2")) + 
  labs(title ="Hematoma immune-aged (Monocle3)", x = c(color =''), y = 'Pseudotime') 
